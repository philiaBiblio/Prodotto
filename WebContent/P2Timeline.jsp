      ...
      <div class="header_container">
        ...
        <div class="search">
          ...
          <select id="filter" class="filter-button" onChange="location.href=value;">
            ...
            <option value="ユーザー検索画面.html">アカウント名</option>
          </select>
        ...
        <div>
          ...
          <div class="nav_list">
            <div class="nav_items navtop">
              <a href="P2Timeline.html" class="nav_link navtop active">
                <i class="fa fa-house nav_icon"></i>
                <span class="nav_name">タイムライン</span>
              </a>

              <a href="P2DM.html" class="nav_link navtop nav_soroe">
              ...
              <a href="P2Ranking.html" class="nav_link navtop nav_soroe">
              ...
              <a href="P2PostAndRecording.html" class="nav_link navtop nav_soroe">
              ...
              <a href="P2ProfileMine.html" class="nav_link navtop nav_soroe">
                <!-- <i class="fa-solid fa-users nav_icon"></i> -->
                <div class="nav_icon nav_soroe">
                  <i class="gg-boy"></i>
                </div>
              ...
              <a href="P2Settings.html" class="nav_link navtop">
      ...
      <section class="video-grid">
        <div class="video-card">
          ...
          <div class="video-info">
            <a href="P2ProfileStranger.html" class="profile-info">
              <img
                src="image/ききゅう.jpg"
                alt="profile icon"
                class="profile-icon"
