...
(() => {
	var t = {
				...
				return (
					(e = function(e, i, o) {
						...
						for (
							...
							(s = i.exec(e)) &&
							!(
								(u = s.index + s[0].length) > f &&
								(l.push(e.slice(f, s.index)),
									!r &&
									s.length > 1 &&
			...
			(t.exports = function(t, e) {
				...
				return (
					...
					r(t)
						? ((n = s.call(t, "c")),
							...
							(u = s.call(t, "w")))
						: ((n = u = !0), (i = !1)),
					(l = { value: e, configurable: n, enumerable: i, writable: u }),
					c ? o(a(c), l) : l
				);
			}).gs = function(t, e, n) {
				var u, c, l, h;
				return (
					...
					r(e)
						...
						: (e = void 0),
					r(t)
						? ((u = s.call(t, "c")), (c = s.call(t, "e")))
						: ((u = !0), (c = !1)),
					(h = { get: e, set: n, configurable: u, enumerable: c }),
					l ? o(a(l), h) : h
				);
			};
		},
		...
		8709: (t, e, n) => {
			...
			(i = function(t, e) {
				...
				(u = { on: l(r), once: l(i), off: l(o), emit: l(a) }),
				(c = y({}, u)),
				(t.exports = e =
					function(t) {
		...
		4571: (t, e) => {
			...
			Object.defineProperty(e, "__esModule", { value: !0 }),
				...
				(e.sCurve = function(t, e) {
					...
					for (n = 0; n < t; ++n)
						r[n] = Math.sin((Math.PI * n) / t - i) / 2 + 0.5;
					return r;
				}),
				(e.logarithmic = function(t, e, n) {
					...
					for (r = 0; r < t; r++)
						(o = r / t),
							(i[n > 0 ? r : t - 1 - r] =
								Math.log(1 + e * o) / Math.log(1 + e));
					return i;
				});
		},
		9304: (t, e, n) => {
			"use strict";
			(e.h7 = e.Y1 = e.Hp = e.Jl = e.t$ = e._h = void 0),
				(e.L7 = function(t, e, n, r) {
					switch (e) {
						case i:
							u.call(t, n, r);
							break;
			...
			function f(t, e) {
				this.exponentialRampToValueAtTime(0.01, t),
					this.exponentialRampToValueAtTime(1, t + e);
			}
			function p(t, e) {
				this.exponentialRampToValueAtTime(1, t),
					this.exponentialRampToValueAtTime(0.01, t + e);
			}
			function d(t, e) {
			...
			function i(t, e) {
				...
				if (((e = e || {}), r))
					return (
						...
						new n.g.Worker(
							n.g.URL.createObjectURL(
								new n.g.Blob([i], { type: "text/javascript" })
							)
						)
					);
				(this.self = e),
			...
			var b,
				w =
					((b = function(t, e) {
						...
						else for (var n in e) s.call(e, n) && p(t, n, e[n]);
					}),
						(function(t, e) {
							return (
							...
							var n = -1,
								...
								o = r > 2 ? e[2] : void 0;
							for (
								i = b.length > 3 && "function" == typeof i ? (r--, i) : void 0,
								o &&
								(function(t, e, n) {
									if (!k(n)) return !1;
									var r = typeof e;
		...
		6146: (t, e, n) => {
			...
			var w,
				...
				E = T.toString,
				R = O.hasOwnProperty,
				j = (w = /[^.]+$/.exec((_ && _.keys && _.keys.IE_PROTO) || ""))
					? "Symbol(src)_1." + w
					: "",
				A = O.toString,
				C = E.call(Object),
							...
							if ((i || (i = new K()), xt(o)))
								!(function(t, e, n, r, i, o, a) {
									...
									if (l) Q(t, n, l);
											...
											(y = c),
												g || k || b
													? mt(u)
														...
														: Pt((v = u)) && gt(v)
															...
															: k
																...
																: b
																	? ((m = !1),
																		(d = new (p = (h = c).buffer).constructor(
																			p.byteLength
																		)),
																		new I(d).set(new I(p)),
																		(f = d),
													...
													: (function(t) {
														...
														if (null === e) return !0;
														var n =
															R.call(e, "constructor") && e.constructor;
														return (
															"function" == typeof n &&
															n instanceof n &&
															E.call(n) == C
										...
										m && (a.set(c, y), i(y, c, r, o, a), a.delete(c)),
											Q(t, n, y);
									}
								})(t, e, a, n, ot, r, i);
							else {
			...
			function ut(t, e, n, r, i, o) {
				return (
					xt(t) &&
					xt(e) &&
					(o.set(e, t), ot(t, e, void 0, ut, o), o.delete(e)),
					t
				);
			}
			function ct(t, e) {
					...
					((_t = function(t, e, n, r) {
						...
						at(function(t, e) {
							var n = -1,
								...
								o = r > 2 ? e[2] : void 0;
							for (
								i = _t.length > 3 && "function" == typeof i ? (r--, i) : void 0,
								o &&
								(function(t, e, n) {
									if (!xt(n)) return !1;
									var r = typeof e;
				...
				return (
					...
					(function(t, e) {
						return (
							...
							(function(t, e, n) {
								for (
									var r = -1, i = Object(t), o = n(t), a = o.length;
									a--;
		...
		8554: (t, e, n) => {
			...
			function o(t, e, n, r) {
				if (r) {
					...
					else if ("attributes" === e) for (var a in o) t.removeAttribute(a);
					else if ("style" === e) for (var s in o) t.style[s] = "";
			...
			t.exports = function(t, e, n) {
				for (var s in e) {
					...
					void 0 === u
						? o(t, s, u, n)
						: i(u)
							? (o(t, s, u, n), u.hook && u.hook(t, s, n ? n[s] : void 0))
							: r(u)
								? a(t, 0, n, s, u)
								: (t[s] = u);
				}
		...
		5556: (t, e, n) => {
			...
			t.exports = function t(e, n) {
				...
				if (!o(e))
					return l && l("Item is not a valid virtual dom node", e), null;
				var h =
					null === e.namespace
						? c.createElement(e.tagName)
						: c.createElementNS(e.namespace, e.tagName),
					f = e.properties;
				i(h, f);
				...
				switch (c) {
					...
					case o.VTEXT:
						return (function(t, e, n, r) {
							var i;
							if (3 === t.nodeType)
								t.replaceData(0, t.length, n.text), (i = t);
							else {
								var o = t.parentNode;
					...
					case o.ORDER:
						return (
							(function(t, e) {
								for (
									var n, r, i, o = t.childNodes, a = {}, s = 0;
									s < e.removes.length;
									s++
								)
		...
		2446: (t, e, n) => {
			...
			t.exports = function t(e, n, r) {
				return (
					((r = r || {}).patch = r.patch && r.patch !== t ? r.patch : u),
					(r.render = r.render || o),
					r.patch(e, n, r)
				);
			};
		...
		9243: (t, e, n) => {
			...
			t.exports = function(t, e) {
				return (
					!(!r(t) || !r(e)) &&
					("name" in t && "name" in e ? t.id === e.id : t.init === e.init)
				);
			};
		},
		2796: (t, e, n) => {
				...
				if ("string" == typeof t) e.push(new o(t));
					...
					if (!r(t)) {
						...
						throw (
							((s = {
								foreignObject: t,
								parentVnode: { tagName: n, properties: i },
							}),
								((u = new Error()).type =
		...
		7303: (t, e, n) => {
			...
			t.exports = function(t, e) {
				...
				var n,
					...
					s,
					u,
					c = !e.hasOwnProperty("id"),
					l = r(t, i),
					h = null;
				for (o.test(l[1]) && (h = "DIV"), u = 0; u < l.length; u++)
					(a = l[u]) &&
						((s = a.charAt(0)),
							h
								? "." === s
									? (n = n || []).push(a.substring(1, a.length))
									: "#" === s && c && (e.id = a.substring(1, a.length))
								: (h = a));
				return (
					n &&
					(e.className && n.push(e.className), (e.className = n.join(" "))),
		...
		1575: (t, e, n) => {
			...
			function s(t, e) {
				var n = t.vnode;
				if ((n || (n = t.vnode = t.render(e)), !(r(n) || i(n) || o(n))))
			...
			t.exports = function(t, e) {
				var n = t,
					r = e;
				return (
					a(e) && (r = s(e, t)), a(t) && (n = s(t, null)), { a: n, b: r }
				);
			};
		},
		5483: (t) => {
		...
		4270: (t) => {
			t.exports = function(t) {
				return (
					t &&
					(("function" == typeof t.hook && !t.hasOwnProperty("hook")) ||
						("function" == typeof t.unhook && !t.hasOwnProperty("unhook")))
				);
			};
		},
		9683: (t, e, n) => {
				...
				for (var k = 0; k < f; k++) {
					...
					i(b)
						? ((p += b.count || 0),
							!d && b.hasWidgets && (d = !0),
							!v && b.hasThunks && (v = !0),
							y || (!b.hooks && !b.descendantHooks) || (y = !0))
						: !d && o(b)
							? "function" == typeof b.destroy && (d = !0)
							: !v && a(b) && (v = !0);
				}
				(this.count = f + p),
					(this.hasWidgets = d),
			...
			function f(t, e, n, r) {
				if (t !== e) {
					...
					if (u(t) || u(e)) v(t, e, n, r);
									...
									(c = (function(t, e, n, r, a) {
										for (
											...
											u = (function(t, e) {
												...
												for (
													var d = u >= i.length ? e.length : i[u], v = 0;
													v < e.length;
													v++
												) {
													var y = e[v];
													y.key
														? a.hasOwnProperty(y.key) || s.push(y)
														: v >= d && s.push(y);
												}
												for (
													var k,
														...
														: T.key
															? (k && k.key && r[k.key] !== S + 1
																? (x.push(m(b, w, k.key)),
																	(k = b[w]) && k.key === T.key
																		? w++
																		: P.push({ key: T.key, to: S }))
																: P.push({ key: T.key, to: S }),
																S++)
															: k && k.key && x.push(m(b, w, k.key));
												}
												for (; w < b.length;)
													(k = b[w]), x.push(m(b, w, k && k.key));
												return x.length !== l || P.length
													? {
														children: s,
														moves: { removes: x, inserts: P },
													}
													: { children: s, moves: null };
											})(s, e.children),
											c = u.children,
											l = s.length,
											h = c.length,
											...
											(a += 1),
												v
													? f(v, y, n, a)
													: y && (r = k(r, new i(i.INSERT, null, y))),
												o(v) && v.count && (a += v.count);
										}
										return (
											u.moves && (r = k(r, new i(i.ORDER, t, u.moves))), r
										);
									})(t, e, n, c, r));
						...
						a(e)
							? a(t)
								? t.text !== e.text && (c = k(c, new i(i.VTEXT, t, e)))
								: ((c = k(c, new i(i.VTEXT, t, e))), (h = !0))
							: s(e) && (s(t) || (h = !0), (c = k(c, new i(i.WIDGET, t, e))));
					c && (n[r] = c), h && p(t, n, r);
				}
			}
			function p(t, e, n) {
			...
			function d(t, e, n) {
				if (s(t))
					"function" == typeof t.destroy &&
						(e[n] = k(e[n], new i(i.REMOVE, t, null)));
		...
		6385: (t) => {
			...
			t.exports = function(t, e, n, a, s, u) {
				...
				if (((a = o(a, 0)), (s = o(s, t.length)), void 0 === t.subarray))
					for (c = 0; c < h; c++)
						(l = t.getChannelData(c).subarray(a, s)), f.push(r(l, e, u));
				...
				return (
					...
					(f = (function(t, e) {
						var n,
							...
							l = i(e, 2 * s);
						for (c = 0; c < s; c++) {
							for (n = 0, r = 0, u = 0; u < o; u++)
								(n += a * t[u][2 * c]), (r += a * t[u][2 * c + 1]);
							(l[2 * c] = n), (l[2 * c + 1] = r);
						}
						return [l];
					})(f, u)),
					{ length: f[0].length / 2, data: f, bits: u }
				);
			};
		},
		8722: (t) => {
	...
	(() => {
		"use strict";
		n.r(r), n.d(r, { default: () => _t, init: () => Ot });
		var t = n(6146),
			e = n.n(t),
			i = n(1583),
			o = n.n(i),
				...
				h(t, [
					...
					},
					{
						...
						value: function(t) {
							...
							return (
								this.setStateChange(2),
								new Promise(function(t, r) {
									e.ac.decodeAudioData(
										n,
										function(n) {
										...
										function(t) {
											r(
												null === t
													? Error("MediaDecodeAudioDataUnknownContentType")
													: t
											);
										}
									);
				...
				h(i, [
					{
						...
						value: function() {
							...
							return new Promise(function(e, n) {
								if (
									t.src.type.match(/audio.*/) ||
									t.src.type.match(/video\/ogg/)
								) {
								...
								if (!e.isScrolling) {
									...
									if (e.isAutomaticScroll) {
										var r = t.getBoundingClientRect(),
											...
											a = e.isPlaying()
												? e.playbackSeconds
												: e.getTimeSelection().start;
										(a < e.scrollLeft || a >= e.scrollLeft + o) &&
											(e.scrollLeft = Math.min(a, e.duration - o));
									}
					...
					h(t, [
						{
							...
							value: function(t, e, n) {
								...
								if (
									...
									n.samplesPerPixel !== this.samplesPerPixel
								) {
									var i = t.width,
										o = t.height,
										a = t.getContext("2d");
			...
			N = (function() {
				function t(e, n, r, i) {
					...
					c(this, t),
						...
						(this.colors = a),
						(this.timeinfo = {
							2e4: { marker: 3e4, bigStep: 1e4, smallStep: 5e3, secondStep: 5 },
							12e3: {
								marker: 15e3,
								bigStep: 5e3,
								smallStep: 1e3,
							...
							1e4: { marker: 1e4, bigStep: 5e3, smallStep: 1e3, secondStep: 1 },
							5e3: {
								marker: 5e3,
								bigStep: 1e3,
								smallStep: 500,
							...
							},
							{
								...
								value: function() {
									for (
										...
										n = this.sampleRate / this.samplesPerPixel,
										r = S(this.offset, this.samplesPerPixel, this.sampleRate),
										i = this.getScaleInfo(this.samplesPerPixel),
										o = {},
										a = [],
										s = e + r,
										u = 0,
										...
										var l = Math.floor(c),
											h = l - r;
										l >= r &&
											(i.marker && u % i.marker == 0
												? (a.push(
													v()(
														"div.time",
														{
															attributes: {
																style: "position: absolute; left: ".concat(
																	h,
																	"px;"
																),
															},
													...
													(o[h] = 10))
												: i.bigStep && u % i.bigStep == 0
													? (o[h] = 5)
													: i.smallStep && u % i.smallStep == 0 && (o[h] = 2)),
											(u += 1e3 * i.secondStep);
									}
									return v()(
										"div.playlist-time-scale",
										{
											attributes: {
												style:
													"position: relative; left: 0; right: 0; margin-left: ".concat(
														this.marginLeft,
														"px;"
													),
											},
						...
						[
							{
								...
								value: function(t) {
									var e = t / 1e3,
										...
										r = (e - n) / 60;
									return (
										n < 10 && (n = "0".concat(n)), "".concat(r, ":").concat(n)
									);
								},
							},
						]
		...
		for (var Z = [], J = 0; J < 256; ++J)
			Z.push((J + 256).toString(16).substr(1));
					...
					h(
						...
						[
							...
							},
							{
								...
								value: function(t) {
									this.active &&
										(t.preventDefault(), this.emitSelection(t.offsetX));
								},
							},
							{
								key: "mouseup",
					...
					h(
						...
						[
							...
							},
							{
								...
								value: function(t) {
									this.active &&
										(t.preventDefault(), this.emitShift(t.offsetX));
								},
							},
							{
								key: "mouseup",
					...
					h(
						...
						[
							...
							},
							{
								...
								value: function(t) {
									var e = P(t.offsetX, this.samplesPerPixel, this.sampleRate);
									e > this.track.getStartTime() &&
										e < this.track.getEndTime() &&
										this.track.ee.emit(
											"fadein",
											e - this.track.getStartTime(),
											this.track
		...
		const st = { cursor: nt, select: rt, shift: it, fadein: ot, fadeout: at },
			ut = (function() {
						...
						[
							{
								...
								value: function(e, n, r) {
									if (
										...
										r.samplesPerPixel !== this.samplesPerPixel
									) {
									...
									(e =
										0 === this.stereoPan
											...
											: this.stereoPan < 0
												...
												: "Right");
								var n = "".concat(
									Math.abs(Math.round(100 * this.stereoPan)),
									"% "
								);
								t.title = "Pan: "
									.concat(0 !== this.stereoPan ? n : "")
									.concat(e);
							},
						},
					]),
			...
			dt = (function() {
				function t() {
					c(this, t),
						...
						(this.gain = 1),
						(this.fades = {}),
						(this.peakData = { type: "WebAudio", mono: !1 }),
						(this.cueIn = 0),
						(this.cueOut = 0),
						(this.duration = 0),
						(this.startTime = 0),
					...
					h(t, [
						...
						},
						{
							...
							value: function(t) {
								...
								var n = { shape: e, start: 0, end: t };
								this.fadeIn &&
									(this.removeFade(this.fadeIn), (this.fadeIn = void 0)),
									(this.fadeIn = this.saveFade(et.Y1, n.shape, n.start, n.end));
							},
						},
						{
							key: "setFadeOut",
							value: function(t) {
								...
								this.fadeOut &&
									(this.removeFade(this.fadeOut), (this.fadeOut = void 0)),
						...
						},
						{
							...
							value: function(t, e, n, r) {
								var i = K();
								return (
									(this.fades[i] = { type: t, shape: e, start: n, end: r }), i
								);
							},
						},
						{
						...
						},
						{
							...
							value: function(t, e, n, r) {
								var i,
									...
									u = U()(
										{},
										{ shouldPlay: !0, masterGain: 1, isOffline: !1 },
										r
									),
								...
								this.startTime >= e
									? ((i = 0),
										...
										n
											? ((s -= this.startTime - e),
												(o = Math.min(s, this.duration)))
											: (o = this.duration))
									: ((i = e - this.startTime),
										(o = n
											? Math.min(s, this.duration - i)
											: this.duration - i)),
									(i += this.cueIn);
								var l = e - this.startTime,
									h = c.setUpSource();
								return (
									B()(this.fades, function(e) {
										var n, r;
										if (l < e.end)
											switch (
											(l <= e.start
												? ((n = t + (e.start - l)), (r = e.end - e.start))
												: l > e.start &&
												l < e.end &&
												((n = t - (l - e.start)), (r = e.end - e.start)),
												e.type)
											) {
												case et.Y1:
							...
							value: function(t) {
								var e = this,
									...
									r = {
										attributes: {
											style:
												"position: absolute; top: 0; right: 0; bottom: 0; left: 0; width: ".concat(
													n,
													"px; z-index: 9;"
												),
										},
							...
							value: function(t) {
								var e = this,
									...
									s = v()(
										...
										{
											attributes: { type: "button", title: "Remove track" },
											onclick: function() {
									...
									c = v()(
										"button.btn.btn-info.btn-xs.track-collapse",
										{
											...
											onclick: function() {
												e.ee.emit("changeTrackView", e, { collapsed: !i });
											},
										},
								...
								return (
									...
									(a.muteOrSolo &&
										h.push(
											v()("div.btn-group", [
												v()(
													"button.btn.btn-outline-dark.btn-xs.btn-mute".concat(
														n
													),
													{
												...
												v()(
													"button.btn.btn-outline-dark.btn-xs.btn-solo".concat(
														r
													),
													{
														onclick: function() {
							...
							value: function(t) {
								...
								var c = [
									v()("div.cursor", {
										attributes: {
											style:
												"position: absolute; width: 1px; margin: 0; padding: 0; top: 0; left: ".concat(
													r,
													"px; bottom: 0; z-index: 5;"
												),
										},
									}),
								],
									l = Object.keys(this.peaks.data).map(function(r) {
										for (
											var o = [
												v()("div.channel-progress", {
													attributes: {
														style: "position: absolute; width: "
															.concat(a, "px; height: ")
															.concat(t.height, "px; z-index: 2;"),
													},
												}),
											],
											s = 0,
											...
											o.push(
												v()("canvas", {
													attributes: {
														...
														height: t.height * u,
														style:
															"float: left; position: relative; margin: 0; padding: 0; z-index: 3; width: "
																.concat(h, "px; height: ")
																.concat(t.height, "px;"),
													},
													hook: new ut(
													...
													"div.wp-fade.wp-fadein",
													{
														attributes: {
															style: "position: absolute; height: "
																.concat(t.height, "px; width: ")
																.concat(d, "px; top: 0; left: 0; z-index: 4;"),
														},
													},
													[
														v()("canvas", {
															attributes: { width: d, height: t.height },
															hook: new ht(
																p.type,
																p.shape,
																p.end - p.start,
												...
												v()(
													"div.wp-fade.wp-fadeout",
													{
														attributes: {
															style: "position: absolute; height: "
																.concat(t.height, "px; width: ")
																.concat(m, "px; top: 0; right: 0; z-index: 4;"),
														},
													},
													[
														v()("canvas", {
															attributes: { width: m, height: t.height },
															hook: new ht(
																y.type,
																y.shape,
																y.end - y.start,
										...
										return v()(
											"div.channel.channel-".concat(r),
											{
												attributes: {
													style: "height: "
														.concat(t.height, "px; width: ")
														.concat(n, "px; top: ")
														.concat(r * t.height, "px; left: ")
														.concat(
															i,
															"px; position: absolute; margin: 0; padding: 0; z-index: 1;"
														),
												},
											},
											o
								...
								if (
									(c.push(l), c.push(this.renderOverlay(t)), !0 === t.isActive)
								) {
									var h = S(t.timeSelection.start, t.resolution, t.sampleRate),
										f =
											S(t.timeSelection.end, t.resolution, t.sampleRate) -
											h +
											1,
										p = f > 1 ? ".segment" : ".point";
									c.push(
										v()("div.selection".concat(p), {
											attributes: {
												style: "position: absolute; width: "
													.concat(f, "px; bottom: 0; top: 0; left: ")
													.concat(h, "px; z-index: 4;"),
											},
										})
									);
								}
								var d = v()(
									...
									m = 0;
								t.controls.show &&
									(y.push(this.renderControls(t)), (m = t.controls.width)),
									y.push(d);
						...
						},
						{
							...
							value: function() {
								...
								if (this.fadeIn) {
									...
									t.fadeIn = { shape: e.shape, duration: e.end - e.start };
								}
								if (this.fadeOut) {
									var n = this.fades[this.fadeOut];
									t.fadeOut = { shape: n.shape, duration: n.end - n.start };
								}
								return t;
							},
						},
		...
		var yt = (function() {
			function t(e, n) {
				...
				c(this, t),
					(this.ac = e),
					(this.gain = 1),
					(this.effectsGraph = vt),
					(this.masterEffectsGraph = vt),
					(this.buffer = n),
					(this.masterGain = r),
			...
			return (
				h(t, [
					...
					},
					{
						...
						value: function(t) {
							this.shouldPlayGain &&
								(this.shouldPlayGain.gain.value = t ? 1 : 0);
						},
					},
					{
						key: "setMasterGainLevel",
				...
				h(t, [
					{
						...
						value: function() {
							...
							this.annotations.forEach(function(e, n) {
								var r = new gt(t.playlist, { direction: "left", index: n }),
									i = new gt(t.playlist, { direction: "right", index: n });
					...
					},
					{
						...
						value: function() {
							var t = this.annotations.map(function(t) {
								...
								e = "data:text/json;charset=utf-8,".concat(
							...
							var t = this,
								e = v()(
									"div.annotations-boxes",
									{
										attributes: {
											style:
												"height: 30px; position: relative; margin-left: ".concat(
													this.marginLeft,
													"px;"
												),
										},
									...
									this.annotations.map(function(e, n) {
										...
										return v()(
											...
											{
												attributes: {
													style: "position: absolute; height: 30px; width: "
														.concat(u, "px; left: ")
														.concat(s, "px"),
													"data-id": e.id,
												},
												...
												v()(
													"span.id",
													{
														onclick: function() {
															...
															t.playlist.isContinuousPlay
																? (t.playlist.seek(e, e),
																	t.playlist.ee.emit("play", e))
																: (t.playlist.seek(e, r),
								...
								r = v()(
									...
									this.annotations.map(function(e, n) {
										var r = (function(t) {
											...
											o = r(e.end),
											a = "";
										t.playlist.isPlaying() &&
											t.playlist.playbackSeconds >= e.start &&
											t.playlist.playbackSeconds <= e.end &&
											(a = ".current");
										var s = {
											attributes: { contenteditable: !0 },
											oninput: function(t) {
												e.lines = [t.target.innerText];
											},
											onkeypress: function(t) {
												(13 !== t.which && 13 !== t.keyCode) ||
													(t.target.blur(), t.preventDefault());
											},
										},
											u = t.editable ? s : {};
										return v()("div.annotation".concat(a), [
											v()("span.annotation-id", [e.id]),
											v()("span.annotation-start", [i]),
											v()("span.annotation-end", [o]),
											v()("span.annotation-lines", u, [e.lines]),
											v()("span.annotation-actions", t.renderControls(e, n)),
										]);
									})
								);
		...
		function Pt() {
			...
			function n(n, r, i) {
				for (
					...
					l = n.length,
					h = Math.ceil(l / r),
					f = new self["Int".concat(i, "Array")](2 * h),
					p = 0;
					p < h;
					p += 1
				)
					...
					case "exportWAV":
						(u = s.data.type),
							(c = (function(e) {
								...
								return (
									i(a, 0, "RIFF"),
									a.setUint32(4, 32 + 2 * e.length, !0),
									i(a, 8, "WAVE"),
									i(a, 12, "fmt "),
									a.setUint32(16, 16, !0),
									a.setUint16(20, 1, !0),
									a.setUint16(22, n ? 1 : 2, !0),
									a.setUint32(24, t, !0),
								...
								(function(t, e) {
									for (
										...
										(r[(i += 1)] = t[o]), (r[(i += 1)] = e[o]), (o += 1);
									return r;
								})(a(n, e), a(r, e))
							)),
							// 音声データをBlobとして作成
							l = new Blob([c], { type: u });
						console.log("音声データがここに格納されています:", l);

						// 任意のファイル名を指定
						const fileName = "recorded_audio.wav";
						const file = new File([l], fileName, { type: l.type });

						console.log("ファイルオブジェクトがここに格納されています:", file);
				...
				h(t, [
										...
										I.createLoader(n, e.ac)
											...
											.then(function(t) {
												e.recorderWorker.postMessage({
													...
													e.recordingTrack.setPlayout(
														new yt(e.ac, t, e.masterGainNode)
													),
													e.adjustDuration();
											})
											.catch(function() {
					...
					},
					{
						...
						value: function(t) {
							var e = this,
								n = t.map(function(t) {
									return I.createLoader(t.src, e.ac, e.ee)
										.load()
										.then(function(t) {
											return t.sampleRate === e.sampleRate
												? t
												: (function(t, e) {
								...
								.then(function(n) {
									...
									var r = n.map(function(n, r) {
										var i = t[r],
											...
											d = i.soloed || !1,
											v = i.selected,
											y = i.peaks || { type: "WebAudio", mono: e.mono },
					...
					},
					{
						...
						value: function() {
							...
							(this.timeSelection = { start: t, end: void 0 === e ? t : e }),
								(this.cursor = t);
						},
					},
					{
										...
										for (; ;)
											switch ((t.prev = t.next)) {
												...
												case 13:
													(o = t.sent),
														"buffer" === e
															? (this.ee.emit("audiorenderingfinished", e, o),
																(this.isRendering = !1))
															: "wav" === e &&
					...
					},
					{
						...
						value: function(t) {
							...
							e > -1
								? this.soloedTracks.splice(e, 1)
								: this.exclSolo
									? (this.soloedTracks = [t])
									: this.soloedTracks.push(t);
						},
					},
					{
						key: "collapseTrack",
					...
					},
					{
						...
						value: function(t) {
							var e;
							return (
								this.soloedTracks.length > 0
									? ((e = !1), this.soloedTracks.indexOf(t) > -1 && (e = !0))
									: ((e = !0), this.mutedTracks.indexOf(t) > -1 && (e = !1)),
								e
							);
						},
					},
					...
					},
					{
						...
						value: function() {
							return (
								(this.lastSeeked || this.pausedAt || this.cursor) +
								this.getElapsedTime()
							);
						},
					},
					...
					},
					{
						...
						value: function(t, e) {
							...
							var r = this.ac.currentTime,
								...
								s = e;
							return (
								!s && i.end !== i.start && i.end > a && (s = i.end),
								this.isPlaying()
									? this.restartPlayFrom(a, s)
									: (this.effectsGraph &&
										this.tracks &&
										this.tracks[0].playout.setMasterEffects(
											this.effectsGraph
										),
										this.tracks.forEach(function(t) {
											t.setState("cursor"),
												o.push(
													t.schedulePlay(r, a, s, {
					...
					},
					{
						...
						value: function() {
							var t = this;
							return this.stop().then(function() {
								t.viewDuration < t.duration
									? (t.scrollLeft = t.duration - t.viewDuration)
									: (t.scrollLeft = 0),
						...
						value: function() {
							...
							this.mediaRecorder.start(300),
								this.tracks.forEach(function(n) {
									n.setState("none"),
										e.push(
											n.schedulePlay(t.ac.currentTime, 0, void 0, {
					...
					},
					{
						...
						value: function(t, e, n) {
							this.isPlaying()
								? ((this.lastSeeked = t),
									(this.pausedAt = void 0),
									this.restartPlayFrom(t))
								: (this.setActiveTrack(n || this.tracks[0]),
									(this.pausedAt = t),
					...
					},
					{
						...
						value: function(t) {
							...
							if (this.isPlaying()) {
								...
								i + o >= (this.isSegmentSelection() ? r.end : this.duration) &&
					...
					},
					{
						...
						value: function() {
							var t = [];
							return (
								this.showTimescale && t.push(this.renderTimeScale()),
					...
					},
					{
						...
						value: function() {
							...
							return (
								...
								{ tracks: t, effects: this.effectsGraph }
							);
						},
					},
				]),
		...
		function Ot() {
			...
			u.setAudioContext(c),
				u.setSampleRate(i.sampleRate || c.sampleRate),
				u.setSamplesPerPixel(i.samplesPerPixel),
				u.setEventEmitter(n),
				u.setUpEventEmitter(),
				u.setTimeSelection(0, 0),
				u.setState(i.state),
				u.setControlOptions(i.controls),
				u.setWaveHeight(i.waveHeight),
				u.setCollapsedWaveHeight(i.collapsedWaveHeight),
				u.setColors(i.colors),
				u.setZoomLevels(i.zoomLevels),
				u.setZoomIndex(a),
				u.setMono(i.mono),
				u.setExclSolo(i.exclSolo),
				u.setShowTimeScale(i.timescale),
				u.setSeekStyle(i.seekStyle),
				u.setAnnotations(i.annotationList),
				u.setBarGap(i.barGap),
				u.setBarWidth(i.barWidth),
				(u.isAutomaticScroll = i.isAutomaticScroll),
				(u.isContinuousPlay = i.isContinuousPlay),
				(u.linkedEndpoints = i.linkedEndpoints),
				i.effects && u.setEffects(i.effects);
			var l = u.render(),
				h = o()(l);
