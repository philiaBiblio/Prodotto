...
<link rel="stylesheet" href="録音画面.css" />
...
<body>
	...
	<script>
		...
		ga("create", "UA-62186746-1", "auto"); // Google AnalyticsアカウントのID設定
		ga("send", "pageview"); // ページビューをトラッキング
	</script>
			...
			<article class="post">
				...
				<div class="btn-group">
					<button type="submit" class="btn btn-download btn-outline-primary"
						...
						onclick="setTimeout(function () { location.href='DownloadServlet' }, 30000);">
