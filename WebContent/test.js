...
( () => {
    var t = {
            ...
            t.exports = function(t) {
                ...
                return e = function(e, i, o) {
                    if ("[object RegExp]" !== Object.prototype.toString.call(i))
                        return n.call(e, i, o);
                    var a, s, u, c, l = [], h = (i.ignoreCase ? "i" : "") + (i.multiline ? "m" : "") + (i.extended ? "x" : "") + (i.sticky ? "y" : ""), f = 0;
                    for (i = new RegExp(i.source,h + "g"),
                    e += "",
                    r || (a = new RegExp("^" + i.source + "$(?!\\s)",h)),
                    o = o === t ? -1 >>> 0 : o >>> 0; (s = i.exec(e)) && !((u = s.index + s[0].length) > f && (l.push(e.slice(f, s.index)),
                    !r && s.length > 1 && s[0].replace(a, (function() {
                        for (var e = 1; e < arguments.length - 2; e++)
                            arguments[e] === t && (s[e] = t)
                    }
                    )),
                    s.length > 1 && s.index < e.length && Array.prototype.push.apply(l, s.slice(1)),
                    c = s[0].length,
                    f = u,
                    l.length >= o)); )
                        i.lastIndex === s.index && i.lastIndex++;
                    return f === e.length ? !c && i.test("") || l.push("") : l.push(e.slice(f)),
        ...
        2696: (t, e, n) => {
            "use strict";
            t.exports = n(2543)() ? Object.assign : n(7031)
        }
        ,
        2543: t => {
            "use strict";
        ...
        3577: (t, e, n) => {
            "use strict";
            t.exports = n(3456)() ? Object.keys : n(9276)
        }
        ,
        3456: t => {
            "use strict";
        ...
        4138: (t, e, n) => {
            "use strict";
            t.exports = n(2737)() ? String.prototype.contains : n(7613)
        }
        ,
        2737: t => {
            "use strict";
        ...
        1464: (t, e, n) => {
            "use strict";
            var r, i, o, a, s, u, c, l = n(5219), h = n(4191), f = Function.prototype.apply, p = Function.prototype.call, d = Object.create, v = Object.defineProperty, y = Object.defineProperties, m = Object.prototype.hasOwnProperty, g = {
                configurable: !0,
                enumerable: !1,
                writable: !0
            };
            ...
            s = {
                on: r = function(t, e) {
                    var n;
                    return h(e),
                    m.call(this, "__ee__") ? n = this.__ee__ : (n = g.value = d(null),
                    v(this, "__ee__", g),
                    g.value = null),
        ...
        186: (t, e) => {
            ...
            e.linear = function(t, e) {
                var n, r, i = new Float32Array(t), o = t - 1;
                for (n = 0; n < t; n++)
                    r = n / o,
                    i[n] = e > 0 ? r : 1 - r;
                return i
            ...
            e.exponential = function(t, e) {
                ...
                for (n = 0; n < t; n++)
                    r = n / o,
                    i[e > 0 ? n : t - 1 - n] = Math.exp(2 * r - 1) / Math.exp(1);
                return i
            }
            ,
            e.sCurve = function(t, e) {
                var n, r = new Float32Array(t), i = e > 0 ? Math.PI / 2 : -Math.PI / 2;
                for (n = 0; n < t; ++n)
                    r[n] = Math.sin(Math.PI * n / t - i) / 2 + .5;
                return r
            }
            ,
            e.logarithmic = function(t, e, n) {
                var r, i = new Float32Array(t), o = 0;
                for (r = 0; r < t; r++)
                    o = r / t,
                    i[n > 0 ? r : t - 1 - r] = Math.log(1 + e * o) / Math.log(1 + e);
                return i
            }
        }
        ,
        1694: (t, e, n) => {
            "use strict";
            e.Fy = e.sD = e.KK = e.Wu = e._Q = e.Hv = void 0,
            e.q8 = function(t, e, n, r) {
                switch (e) {
                case i:
                    u.call(t, n, r);
                    break;
            ...
            function l(t, e) {
                this.linearRampToValueAtTime(0, t),
                this.linearRampToValueAtTime(1, t + e)
            }
            function h(t, e) {
                this.linearRampToValueAtTime(1, t),
                this.linearRampToValueAtTime(0, t + e)
            }
            function f(t, e) {
                this.exponentialRampToValueAtTime(.01, t),
                this.exponentialRampToValueAtTime(1, t + e)
            }
            function p(t, e) {
                this.exponentialRampToValueAtTime(1, t),
                this.exponentialRampToValueAtTime(.01, t + e)
            }
            function d(t, e) {
                var n = (0,
                r.logarithmic)(1e4, 10, 1);
                this.setValueCurveAtTime(n, t, e)
            }
            function v(t, e) {
                var n = (0,
        ...
        ,
        7509: (t, e, n) => {
            var r, i = void 0 !== n.g ? n.g : "undefined" != typeof window ? window : {}, o = n(4626);
        ...
        445: (t, e, n) => {
            ...
            function i(t, e) {
                ...
                if (e = e || {},
                r)
                    return i = t.toString().trim().match(/^function\s*\w*\s*\([\w\s,]*\)\s*{([\w\W]*?)}$/)[1],
                    new n.g.Worker(n.g.URL.createObjectURL(new n.g.Blob([i],{
                        type: "text/javascript"
                    })));
                this.self = e,
                this.self.postMessage = function(t) {
                    setTimeout((function() {
                        o.onmessage({
                            data: t
                        })
        ...
        ,
        9203: t => {
            var e, n, r = 9007199254740991, i = /^(?:0|[1-9]\d*)$/, o = Object.prototype, a = o.hasOwnProperty, s = o.toString, u = o.propertyIsEnumerable, c = (e = Object.keys,
            n = Object,
            function(t) {
                return e(n(t))
            }
            ...
            var k, b = (k = function(t, e) {
                if (h || d(e) || m(e))
                    !function(t, e, n) {
                        ...
                        return m(t) ? function(t, e) {
                            var n = y(t) || function(t) {
                              ...
                              , i = !!r;
                            for (var o in t)
                                !e && !a.call(t, o) || i && ("length" == o || p(o, r)) || n.push(o);
                            return n
                        }(t) : function(t) {
                            if (!d(t))
                                return c(t);
                    ...
                    for (var n in e)
                        a.call(e, n) && f(t, n, e[n])
            }
            ,
            function(t, e) {
                return e = l(void 0 === e ? t.length - 1 : e, 0),
                function() {
                    for (var n = arguments, r = -1, i = l(n.length - e, 0), o = Array(i); ++r < i; )
                        o[r] = n[e + r];
                    r = -1;
                ...
                var n = -1
                  ...
                  , i = r > 1 ? e[r - 1] : void 0
                  , o = r > 2 ? e[2] : void 0;
                for (i = k.length > 3 && "function" == typeof i ? (r--,
                i) : void 0,
                o && function(t, e, n) {
                    if (!g(n))
                        return !1;
                    var r = typeof e;
                    return !!("number" == r ? m(n) && p(e, n.length) : "string" == r && e in n) && v(n[e], t)
                }(e[0], e[1], o) && (i = r < 3 ? void 0 : i,
                r = 1),
                t = Object(t); ++n < r; ) {
                    var a = e[n];
                    a && k(t, a)
        ...
        9218: (t, e, n) => {
            ...
            var w, x, P, S = Array.prototype, T = Function.prototype, O = Object.prototype, _ = p["__core-js_shared__"], E = T.toString, R = O.hasOwnProperty, j = (w = /[^.]+$/.exec(_ && _.keys && _.keys.IE_PROTO || "")) ? "Symbol(src)_1." + w : "", A = O.toString, C = E.call(Object), L = RegExp("^" + E.call(R).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), G = y ? p.Buffer : void 0, F = p.Symbol, I = p.Uint8Array, M = (G && G.allocUnsafe,
            x = Object.getPrototypeOf,
            P = Object,
            function(t) {
                return x(P(t))
            }
            ), D = Object.create, N = O.propertyIsEnumerable, z = S.splice, V = F ? F.toStringTag : void 0, W = function() {
                try {
                    var t = lt(Object, "defineProperty");
                    return t({}, "", {}),
                    t
                } catch (t) {}
            }(), U = G ? G.isBuffer : void 0, q = Math.max, B = Date.now, H = lt(p, "Map"), X = lt(Object, "create"), $ = function() {
                function t() {}
                return function(e) {
                    if (!xt(e))
                        return {};
            ...
            Z.prototype.delete = function(t) {
                var e = this.__data__
                  , n = et(e, t);
                return !(n < 0 || (n == e.length - 1 ? e.pop() : z.call(e, n, 1),
                --this.size,
                0))
            }
            ,
                    ...
                    xt(o))
                        !function(t, e, n, r, i, o, a) {
                            ...
                            if (l)
                                ...
                                var h, f, p, d, v, y = o ? o(u, c, n + "", t, e, a) : void 0, m = void 0 === y;
                                if (m) {
                                    var g = mt(c)
                                      , k = !g && kt(c)
                                      , b = !g && !k && St(c);
                                    y = c,
                                    g || k || b ? mt(u) ? y = u : Pt(v = u) && gt(v) ? y = function(t, e) {
                                        var n = -1
                                          , r = t.length;
                                        for (e || (e = Array(r)); ++n < r; )
                                            e[n] = t[n];
                                    ...
                                    d = new (p = (h = c).buffer).constructor(p.byteLength),
                                    new I(d).set(new I(p)),
                                    f = d,
                                    y = new h.constructor(f,h.byteOffset,h.length)) : y = [] : function(t) {
                                        if (!Pt(t) || rt(t) != s)
                                            return !1;
                                        var e = M(t);
                                        if (null === e)
                                    ...
                                    yt(u) ? y = function(t) {
                                        ...
                                        return "function" != typeof t.constructor || ft(t) ? {} : $(M(t))
                                    }(c))) : m = !1
                                }
                                m && (a.set(c, y),
                                i(y, c, r, o, a),
            ...
            function Ot(t) {
                return gt(t) ? function(t, e) {
                    var n = mt(t)
                      ...
                      , u = s.length;
                    for (var c in t)
                        !e && !R.call(t, c) || a && ("length" == c || i && ("offset" == c || "parent" == c) || o && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || ht(c, u)) || s.push(c);
                    return s
                }(t, !0) : function(t) {
                    if (!xt(t))
                        return function(t) {
                    ...
                    var e = ft(t)
                      , n = [];
                    for (var r in t)
                        ("constructor" != r || !e && R.call(t, r)) && n.push(r);
                    return n
                }(t)
            }
            ...
            at((function(t, e) {
                var n = -1
                  ...
                  , i = r > 1 ? e[r - 1] : void 0
                  , o = r > 2 ? e[2] : void 0;
                for (i = _t.length > 3 && "function" == typeof i ? (r--,
                i) : void 0,
                o && function(t, e, n) {
                    if (!xt(n))
                        return !1;
            ...
            function p(t) {
                return f(t) ? function(t, e) {
                    var n = h(t) || function(t) {
                      ...
                      , i = !!r;
                    for (var o in t)
                        !e && !a.call(t, o) || i && ("length" == o || l(o, r)) || n.push(o);
                    return n
                }(t) : function(t) {
                    if (n = (e = t) && e.constructor,
                    e !== ("function" == typeof n && n.prototype || o))
                        return c(t);
                    var e, n, r = [];
                    for (var i in Object(t))
                        a.call(t, i) && "constructor" != i && r.push(i);
                    return r
                }(t)
            }
            function d(t) {
        ...
        4288: (t, e, n) => {
            ...
            t.exports = function(t, e, n) {
                for (var s in e) {
                    var u = e[s];
                    void 0 === u ? o(t, s, u, n) : i(u) ? (o(t, s, u, n),
                    u.hook && u.hook(t, s, n ? n[s] : void 0)) : r(u) ? a(t, 0, n, s, u) : t[s] = u
                }
            }
        }
        ,
        7563: (t, e, n) => {
            ...
            t.exports = function t(e, n) {
                ...
                s(e))
                    return e.init();
                if (a(e))
                    return c.createTextNode(e.text);
                if (!o(e))
                    return l && l("Item is not a valid virtual dom node", e),
                    null;
        ...
        452: (t, e, n) => {
            ...
            t.exports = function(t, e, n) {
                var i, u, c = t.type, l = t.vNode, h = t.patch;
                switch (c) {
                case o.REMOVE:
                    return function(t, e) {
                        var n = t.parentNode;
                        return n && n.removeChild(t),
                        s(t, e),
                        null
                    }(e, l);
                case o.INSERT:
                ...
                case o.VTEXT:
                    return function(t, e, n, r) {
                        var i;
                        if (3 === t.nodeType)
                            t.replaceData(0, t.length, n.text),
                            i = t;
                        else {
                            var o = t.parentNode;
                            i = r.render(n, r),
                            o && i !== t && o.replaceChild(i, t)
                        }
                        return i
                    }(e, 0, h, n);
                case o.WIDGET:
                    return function(t, e, n, r) {
                        ...
                        var u = t.parentNode;
                        return u && i !== t && u.replaceChild(i, t),
                        o || s(t, e),
                        i
                    }(e, l, h, n);
                case o.VNODE:
                    return function(t, e, n, r) {
                        var i = t.parentNode
                          , o = r.render(n, r);
                        return i && o !== t && i.replaceChild(o, t),
                        o
                    }(e, 0, h, n);
                case o.ORDER:
                    return function(t, e) {
                        for (var n, r, i, o = t.childNodes, a = {}, s = 0; s < e.removes.length; s++)
                            n = o[(r = e.removes[s]).from],
                            r.key && (a[r.key] = n),
                            t.removeChild(n);
                        for (var u = o.length, c = 0; c < e.inserts.length; c++)
                            n = a[(i = e.inserts[c]).key],
                            t.insertBefore(n, i.to >= u++ ? null : o[i.to])
                    }(e, h),
                    e;
                case o.PROPS:
                    return r(e, h, l.properties),
                    e;
                case o.THUNK:
                    return i = e,
                    u = n.patch(e, h, n),
                    i && u && i !== u && i.parentNode && i.parentNode.replaceChild(u, i),
                    u;
                default:
                    return e
                }
        ...
        2230: (t, e, n) => {
            ...
            t.exports = function t(e, n, r) {
                return (r = r || {}).patch = r.patch && r.patch !== t ? r.patch : u,
                r.render = r.render || o,
                r.patch(e, n, r)
            }
        }
        ...
        5441: (t, e, n) => {
            ...
            function d(t, e, n, i) {
                if ("string" == typeof t)
                    ...
                    if (!r(t)) {
                        ...
                        (u = new Error).type = "virtual-hyperscript.unexpected.virtual-element",
                        u.message = "Unexpected virtual child passed to h().\nExpected a VNode / Vthunk / VWidget / string but:\ngot:\n" + y(s.foreignObject) + ".\nThe parent vnode is:\n" + y(s.parentVnode),
                        u.foreignObject = s.foreignObject,
                        u.parentVnode = s.parentVnode,
                        u
                    }
            ...
            t.exports = function(t, e, n) {
                var o, a, s, u, l, y = [];
                return !n && ("string" == typeof (l = e) || r(l) || v(l)) && (n = e,
                a = {}),
                o = h(t, a = a || e || {}),
                a.hasOwnProperty("key") && (s = a.key,
                a.key = void 0),
                a.hasOwnProperty("namespace") && (u = a.namespace,
                a.namespace = void 0),
                "INPUT" !== o || u || !a.hasOwnProperty("value") || void 0 === a.value || c(a.value) || (a.value = f(a.value)),
                function(t) {
                    for (var e in t)
        ...
        8767: (t, e, n) => {
            ...
            t.exports = function(t, e) {
                if (!t)
                    return "DIV";
                var n, a, s, u, c = !e.hasOwnProperty("id"), l = r(t, i), h = null;
                for (o.test(l[1]) && (h = "DIV"),
                u = 0; u < l.length; u++)
                    (a = l[u]) && (s = a.charAt(0),
                    h ? "." === s ? (n = n || []).push(a.substring(1, a.length)) : "#" === s && c && (e.id = a.substring(1, a.length)) : h = a);
                return n && (e.className && n.push(e.className),
                e.className = n.join(" ")),
                e.namespace ? h : h.toUpperCase()
            }
        }
        ,
        3505: (t, e, n) => {
        ...
        1230: (t, e, n) => {
            ...
            function l(t, e, n, r, l) {
                ...
                this.namespace = "string" == typeof l ? l : null;
                var h, f = n && n.length || 0, p = 0, d = !1, v = !1, y = !1;
                for (var m in e)
                ...
                for (var k = 0; k < f; k++) {
                    ...
                    !d && b.hasWidgets && (d = !0),
                    !v && b.hasThunks && (v = !0),
                    y || !b.hooks && !b.descendantHooks || (y = !0)) : !d && o(b) ? "function" == typeof b.destroy && (d = !0) : !v && a(b) && (v = !0)
                }
                this.count = f + p,
                this.hasWidgets = d,
                this.hasThunks = v,
                this.hooks = h,
                this.descendantHooks = y
            }
            l.prototype.version = r,
            l.prototype.type = "VirtualNode"
        }
        ,
        5090: (t, e, n) => {
            var r = n(488);
        ...
        8549: (t, e, n) => {
                                ...
                                c = function(t, e, n, r, a) {
                                    for (var s = t.children, u = function(t, e) {
                                        ...
                                        for (var s = [], u = 0, c = i.length, l = 0, h = 0; h < t.length; h++) {
                                            var f, p = t[h];
                                            p.key ? r.hasOwnProperty(p.key) ? (f = r[p.key],
                                            s.push(e[f])) : (f = h - l++,
                                            s.push(null)) : u < c ? (f = i[u++],
                                            s.push(e[f])) : (f = h - l++,
                                            s.push(null))
                                        }
                                        ...
                                        for (var k, b = s.slice(), w = 0, x = [], P = [], S = 0; S < e.length; ) {
                                            var T = e[S];
                                            for (k = b[w]; null === k && b.length; )
                                                x.push(m(b, w, null)),
                                                k = b[w];
                                            k && k.key === T.key ? (w++,
                                            S++) : T.key ? (k && k.key && r[k.key] !== S + 1 ? (x.push(m(b, w, k.key)),
                                            (k = b[w]) && k.key === T.key ? w++ : P.push({
                                                key: T.key,
                                                to: S
                                            })) : P.push({
                                                key: T.key,
                                        ...
                                        var v = s[d]
                                          , y = c[d];
                                        a += 1,
                                        v ? f(v, y, n, a) : y && (r = k(r, new i(i.INSERT,null,y))),
                                        o(v) && v.count && (a += v.count)
                                    }
                                    return u.moves && (r = k(r, new i(i.ORDER,t,u.moves))),
                                    r
                                }(t, e, n, c, r)
                            } else
                                c = k(c, new i(i.VNODE,t,e)),
                                h = !0;
                        else
                            c = k(c, new i(i.VNODE,t,e)),
                            h = !0;
                    else
                        a(e) ? a(t) ? t.text !== e.text && (c = k(c, new i(i.VTEXT,t,e))) : (c = k(c, new i(i.VTEXT,t,e)),
                        h = !0) : s(e) && (s(t) || (h = !0),
                        c = k(c, new i(i.WIDGET,t,e)));
                    c && (n[r] = c),
                    h && p(t, n, r)
                }
            }
            ...
            function d(t, e, n) {
                if (s(t))
                    "function" == typeof t.destroy && (e[n] = k(e[n], new i(i.REMOVE,t,null)));
                else if (o(t) && (t.hasWidgets || t.hasThunks))
                    for (var r = t.children, a = r.length, c = 0; c < a; c++) {
                        var l = r[c];
                        d(l, e, n += 1),
                        o(l) && l.count && (n += l.count)
                    }
                else
                    u(t) && v(t, null, e, n)
            }
        ...
        4484: t => {
            "use strict";
            function e(t) {
                for (var e, n = 1 / 0, r = -1 / 0, i = 0, o = t.length; i < o; i++)
                    n > (e = t[i]) && (n = e),
                    r < e && (r = e);
                return {
                    min: n,
            ...
            function r(t, r, o) {
                var a, s, u, c, l, h, f = t.length, p = Math.ceil(f / r), d = i(o, 2 * p);
                for (a = 0; a < p; a++)
                    s = a * r,
                    u = (a + 1) * r > f ? f : (a + 1) * r,
                    l = n((h = e(t.subarray(s, u))).min, o),
                    c = n(h.max, o),
                    d[2 * a] = l,
                    d[2 * a + 1] = c;
                return d
            ...
            t.exports = function(t, e, n, a, s, u) {
                ...
                var c, l, h = t.numberOfChannels, f = [];
                if (a = o(a, 0),
                s = o(s, t.length),
                void 0 === t.subarray)
                    for (c = 0; c < h; c++)
                        l = t.getChannelData(c).subarray(a, s),
                        f.push(r(l, e, u));
                else
                    f.push(r(t.subarray(a, s), e, u));
                return n && f.length > 1 && (f = function(t, e) {
                    var n, r, o = t.length, a = 1 / o, s = t[0].length / 2, u = 0, c = 0, l = i(e, 2 * s);
                    for (c = 0; c < s; c++) {
                        for (n = 0,
                        r = 0,
                        u = 0; u < o; u++)
    ...
    ( () => {
        ...
        var A = function() {
            function t(e, n) {
                ...
                this.src = e,
                this.ac = n,
                this.audioRequestState = 0,
                this.ee = r
            }
            return h(t, [{
                key: "setStateChange",
                value: function(t) {
                    this.audioRequestState = t,
                ...
                value: function(t) {
                    var e = 0;
                    0 === this.audioRequestState && this.setStateChange(1),
                    t.lengthComputable && (e = t.loaded / t.total * 100),
                    this.ee.emit("loadprogress", e, this.src)
                }
            }, {
                key: "fileLoad",
                value: function(t) {
                ...
                value: function() {
                    ...
                    return new Promise((function(e, n) {
                        if (t.src.type.match(/audio.*/) || t.src.type.match(/video\/ogg/)) {
                            ...
                            r.readAsArrayBuffer(t.src),
                            r.addEventListener("progress", (function(e) {
                                O(T(i.prototype), "fileProgress", t).call(t, e)
                            }
                            )),
                            r.addEventListener("load", (function(r) {
                                O(T(i.prototype), "fileLoad", t).call(t, r).then((function(t) {
                                    e(t)
                                }
                                )).catch(n)
                            }
                            ...
                            n(Error("Unsupported file type ".concat(t.src.type)))
                    }
                    ))
                }
            }]),
                ...
                value: function(t, e, n) {
                    ...
                    if (void 0 === n || n.offset !== this.offset || n.duration !== this.duration || n.samplesPerPixel !== this.samplesPerPixel) {
                        var i = t.width
                          ...
                          , a = t.getContext("2d");
                        a.clearRect(0, 0, i, o),
                        a.fillStyle = this.colors.timeColor,
                        Object.keys(this.tickInfo).forEach((function(t) {
                            var e = r.tickInfo[t]
                              , n = o - e;
                            a.fillRect(t, n, 1, e)
                        }
            ...
            return h(t, [{
                ...
                value: function() {
                    for (var e = S(this.duration, this.samplesPerPixel, this.sampleRate), n = this.sampleRate / this.samplesPerPixel, r = S(this.offset, this.samplesPerPixel, this.sampleRate), i = this.getScaleInfo(this.samplesPerPixel), o = {}, a = [], s = e + r, u = 0, c = 0; c < s; c += n * i.secondStep) {
                        ...
                        o[h] = 10) : i.bigStep && u % i.bigStep == 0 ? o[h] = 5 : i.smallStep && u % i.smallStep == 0 && (o[h] = 2)),
                        u += 1e3 * i.secondStep
                    }
                    return v()("div.playlist-time-scale", {
                        ...
                        hook: new M(o,this.offset,this.samplesPerPixel,this.duration,this.colors)
                    })])
                }
            }], [{
                key: "formatTime",
        ...
        const N = D;
        var z, V = n(9203), W = n.n(V), U = n(6803), q = n.n(U), B = new Uint8Array(16);
        function H() {
            if (!z && !(z = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto) || "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues && msCrypto.getRandomValues.bind(msCrypto)))
        ...
        for (var $ = [], K = 0; K < 256; ++K)
            $.push((K + 256).toString(16).substr(1));
        const Z = function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0
              , n = ($[t[e + 0]] + $[t[e + 1]] + $[t[e + 2]] + $[t[e + 3]] + "-" + $[t[e + 4]] + $[t[e + 5]] + "-" + $[t[e + 6]] + $[t[e + 7]] + "-" + $[t[e + 8]] + $[t[e + 9]] + "-" + $[t[e + 10]] + $[t[e + 11]] + $[t[e + 12]] + $[t[e + 13]] + $[t[e + 14]] + $[t[e + 15]]).toLowerCase();
            if (!function(t) {
          ...
          , nt = function() {
            ...
            return h(t, [{
                ...
                value: function(t) {
                    ...
                    this.emitSelection(t.offsetX))
                }
            }, {
                key: "mouseup",
                value: function(t) {
                    this.active && (t.preventDefault(),
                    this.complete(t.offsetX))
                }
            }, {
                key: "mouseleave",
                value: function(t) {
          ...
          , rt = function() {
            ...
            return h(t, [{
                ...
                value: function(t) {
                    ...
                    this.prevX = t,
                    this.track.ee.emit("shift", e, this.track)
                }
            }, {
                key: "complete",
                value: function(t) {
                ...
                value: function(t) {
                    ...
                    this.active = !0,
                    this.el = t.target,
                    this.prevX = t.offsetX
                }
            }, {
                key: "mousemove",
                value: function(t) {
                    this.active && (t.preventDefault(),
                    this.emitShift(t.offsetX))
                }
            }, {
                key: "mouseup",
                value: function(t) {
          ...
          , st = function() {
            ...
            return h(t, [{
                ...
                value: function(t, e, n, r, i, o, a) {
                    var s = Math.abs(r * e)
                      , u = Math.abs(i * e);
                    t.fillRect(n, 0, o, e - u),
                    t.fillRect(n, e + s, o, e - s),
                    0 !== a && t.fillRect(n + o, 0, a, 2 * e)
                }
            }]),
            t
        }();
        ...
        var ht = function() {
            ...
            return h(t, [{
                key: "hook",
                value: function(t) {
                    t.value = 100 * this.gain,
                    t.title = "".concat(Math.round(100 * this.gain), "% volume")
                }
            }]),
            t
        }()
          , ft = function() {
            ...
            return h(t, [{
                ...
                value: function(t) {
                    var e;
                    t.value = 100 * this.stereoPan,
                    e = 0 === this.stereoPan ? "Center" : this.stereoPan < 0 ? "Left" : "Right";
            ...
            return h(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (n <= t && r >= t || n <= e && r >= e) {
                        var o = t < n ? n : t
                          , a = e > r ? r : e;
                        this.setCues(o + i, a + i),
                        t > n && this.setStartTime(t)
                    }
                }
            }, {
                key: "setStartTime",
                ...
                value: function(t) {
                    ...
                    this.fadeIn && (this.removeFade(this.fadeIn),
                    this.fadeIn = void 0),
                    this.fadeIn = this.saveFade(tt.sD, n.shape, n.start, n.end)
                }
            }, {
                key: "setFadeOut",
                value: function(t) {
                    ...
                    this.fadeOut && (this.removeFade(this.fadeOut),
                    this.fadeOut = void 0),
                    this.fadeOut = this.saveFade(tt.Fy, n.shape, n.start, n.end)
                }
            }, {
                key: "saveFade",
                ...
                value: function(t, e) {
                    var n = x(this.cueIn, e)
                      , r = x(this.cueOut, e);
                    this.setPeaks(J()(this.buffer, t, this.peakData.mono, n, r))
                }
            }, {
                key: "setPeaks",
                value: function(t) {
                ...
                value: function(t) {
                    if (this.state = t,
                    this.state && this.enabledStates[this.state]) {
                        var e = at[this.state];
                ...
                value: function(t) {
                    this.gain = t,
                    this.playout.setVolumeGainLevel(t)
                }
            }, {
                ...
                value: function(t) {
                    this.stereoPan = t,
                    this.playout.setStereoPanValue(t)
                }
            }, {
                key: "setEffects",
                value: function(t) {
                    this.effectsGraph = t,
                    this.playout.setEffects(t)
                }
            }, {
                key: "schedulePlay",
                value: function(t, e, n, r) {
                    var i, o, a = t, s = n ? n - e : void 0, u = W()({}, {
                        shouldPlay: !0,
                        masterGain: 1,
                        isOffline: !1
                    }, r), c = u.isOffline ? this.offlinePlayout : this.playout;
                    if (this.endTime <= e || s && e + s < this.startTime)
                        return Promise.resolve();
                    this.startTime >= e ? (i = 0,
                    a += this.startTime - e,
                    n ? (s -= this.startTime - e,
                    o = Math.min(s, this.duration)) : o = this.duration) : (i = e - this.startTime,
                    o = n ? Math.min(s, this.duration - i) : this.duration - i),
                    i += this.cueIn;
                    var l = e - this.startTime
                      , h = c.setUpSource();
                    return q()(this.fades, (function(e) {
                        var n, r;
                        if (l < e.end)
                            switch (l <= e.start ? (n = t + (e.start - l),
                            r = e.end - e.start) : l > e.start && l < e.end && (n = t - (l - e.start),
                            r = e.end - e.start),
                            e.type) {
                            case tt.sD:
                    ...
                    c.setVolumeGainLevel(this.gain),
                    c.setShouldPlay(u.shouldPlay),
                    c.setMasterGainLevel(u.masterGain),
                    c.setStereoPanValue(this.stereoPan),
                    c.play(a, i, o),
                    h
                }
            }, {
                ...
                value: function(t) {
                    ...
                    a.volume && h.push(v()("label.volume", [v()("input.volume-slider", {
                        attributes: {
                ...
                value: function(t) {
                      ...
                      , l = Object.keys(this.peaks.data).map((function(r) {
                        for (var o = [v()("div.channel-progress", {
                            ...
                            o.push(v()("canvas", {
                                ...
                                hook: new st(l,s,e.peaks.bits,f,u,t.height,t.barWidth,t.barGap)
                            })),
                            c -= h,
                            s += 1e3
                        }
                        if (e.fadeIn) {
                            ...
                            o.push(v()("div.wp-fade.wp-fadein", {
                                ...
                                hook: new lt(p.type,p.shape,p.end - p.start,t.resolution)
                            })]))
                        }
                        if (e.fadeOut) {
                            ...
                            o.push(v()("div.wp-fade.wp-fadeout", {
                                ...
                                hook: new lt(y.type,y.shape,y.end - y.start,t.resolution)
                            })]))
                        }
                    ...
                    var d = v()("div.waveform", {
                      ...
                      , y = []
                      , m = 0;
                    t.controls.show && (y.push(this.renderControls(t)),
                    m = t.controls.width),
                    y.push(d);
        ...
        var vt = function() {
            function t(e, n) {
                ...
                this.ac = e,
                this.gain = 1,
                this.effectsGraph = dt,
                this.masterEffectsGraph = dt,
                this.buffer = n,
                this.masterGain = r,
            ...
            return h(t, [{
                ...
                value: function(t, e, n) {
                    ...
                    if (t === tt.sD)
                        (0,
                        tt.q8)(this.fadeGain.gain, r, e, n);
                    else {
                        if (t !== tt.Fy)
                            throw new Error("Unsupported fade type");
                        (0,
                        tt.r5)(this.fadeGain.gain, r, e, n)
                    }
                }
            }, {
                key: "applyFadeIn",
                value: function(t, e) {
                    ...
                    this.applyFade(tt.sD, t, e, n)
                }
            }, {
                key: "applyFadeOut",
                value: function(t, e) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "logarithmic";
                    this.applyFade(tt.Fy, t, e, n)
                }
            }, {
                key: "isPlaying",
                value: function() {
                ...
                value: function() {
                    ...
                    var r = new Promise((function(r) {
                        n.source.onended = function() {
                            n.source.disconnect(),
                            n.fadeGain.disconnect(),
                            n.volumeGain.disconnect(),
                            n.shouldPlayGain.disconnect(),
                            n.panner.disconnect(),
                            t && t(),
                            e && e(),
                            n.source = void 0,
                            n.fadeGain = void 0,
                            n.volumeGain = void 0,
                            n.shouldPlayGain = void 0,
                            n.panner = void 0,
                            r()
                        }
                    }
                    ));
                    return this.fadeGain = this.ac.createGain(),
                    ...
                    t = this.effectsGraph(this.panner, this.masterGain, this.ac instanceof (window.OfflineAudioContext || window.webkitOfflineAudioContext)),
                    e = this.masterEffectsGraph(this.masterGain, this.destination, this.ac instanceof (window.OfflineAudioContext || window.webkitOfflineAudioContext)),
                    r
                }
            }, {
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
                    this.panner && (void 0 !== this.panner.pan ? this.panner.pan.value = t : (this.panner.panningModel = "equalpower",
                    this.panner.setPosition(t, 0, 1 - Math.abs(t))))
                }
            }, {
                key: "setEffects",
                value: function() {
          ...
          , yt = function() {
            function t(e) {
                ...
                this.ondragover = function(t) {
                    n.active && (t.preventDefault(),
                    n.emitDrag(t.clientX))
                }
            }
            return h(t, [{
                key: "emitDrag",
                value: function(t) {
                    ...
                    if (e) {
                        ...
                        this.prevX = t,
                        this.playlist.ee.emit("dragged", n, this.data)
                    }
                }
            }, {
                key: "complete",
        ...
        var kt = function() {
            function t(e, n) {
                ...
                this.resizeHandlers = [],
                this.editable = i,
                this.annotations = n.map((function(t) {
                    return {
                        id: (e = t).id || Y(),
                        start: Number(e.begin) || 0,
                        end: Number(e.end) || 0,
                        lines: e.lines || [""],
                        lang: e.language || "en"
                    };
                ...
                this.controls = r,
                this.setupEE(e.ee),
                this.playlist.isContinuousPlay = a,
                this.playlist.linkEndpoints = o,
            ...
            return h(t, [{
                ...
                value: function() {
                    ...
                    this.annotations.forEach((function(e, n) {
                        ...
                        t.resizeHandlers.push(r),
                        t.resizeHandlers.push(i)
                    }
                    ))
                }
            }, {
                ...
                value: function(t) {
                    ...
                    return t.on("dragged", (function(t, n) {
                        ...
                        if ("left" === n.direction) {
                            ...
                            o.start += t,
                            o.start < 0 && (o.start = 0),
                            r && i[r - 1].end > o.start && (i[r - 1].end = o.start),
                            e.playlist.linkEndpoints && r && i[r - 1].end === a && (i[r - 1].end = o.start)
                        } else {
                            var s = o.end;
                            o.end += t,
                            o.end > e.playlist.duration && (o.end = e.playlist.duration),
                            r < i.length - 1 && i[r + 1].start < o.end && (i[r + 1].start = o.end),
                            e.playlist.linkEndpoints && r < i.length - 1 && i[r + 1].start === s && (i[r + 1].start = o.end)
                        }
                      ...
                      , e = v()("div.annotations-boxes", {
                        ...
                        return v()("div.annotation-box", {
                            ...
                            onclick: function() {
                                ...
                                t.playlist.isContinuousPlay ? (t.playlist.seek(e, e),
                                t.playlist.ee.emit("play", e)) : (t.playlist.seek(e, r),
                                t.playlist.ee.emit("play", e, r))
                            }
                      ...
                      , r = v()("div.annotations-text", {
                        ...
                        var s = {
                            ...
                            onkeypress: function(t) {
                                13 !== t.which && 13 !== t.keyCode || (t.target.blur(),
                                t.preventDefault())
                            }
                        }
                          , u = t.editable ? s : {};
        ...
        function wt() {
            function t(t) {
                for (var e, n = 1 / 0, r = -1 / 0, i = 0; i < t.length; i += 1)
                    n > (e = t[i]) && (n = e),
                    r < e && (r = e);
                return {
                    min: n,
            ...
            onmessage = function(n) {
                var r = function(n) {
                    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1e4
                      , i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 8;
                    if ([8, 16, 32].indexOf(i) < 0)
                        throw new Error("Invalid number of bits specified for peaks.");
                    var o = []
                      , a = n.length;
                    return o.push(function(n, r, i) {
                        for (var o, a, s, u, c, l = n.length, h = Math.ceil(l / r), f = new (self["Int".concat(i, "Array")])(2 * h), p = 0; p < h; p += 1)
                            o = p * r,
                            a = (p + 1) * r > l ? l : (p + 1) * r,
                            u = e((c = t(n.subarray(o, a))).min, i),
                            s = e(c.max, i),
                            f[2 * p] = u,
                            f[2 * p + 1] = s;
                        return f
                ...
                }(n.data.samples, n.data.samplesPerPixel);
                postMessage(r)
            }
        }
        function xt() {
            ...
            function o(t, e) {
                for (var n = new Float32Array(e), r = 0, i = 0; i < t.length; i += 1)
                    n.set(t[i], r),
                    r += t[i].length;
                return n
            }
            function a(a) {
                var s = function(e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
                      ...
                      , o = new DataView(r);
                    return i(o, 0, "RIFF"),
                    o.setUint32(4, 32 + 2 * e.length, !0),
                    i(o, 8, "WAVE"),
                    i(o, 12, "fmt "),
                    o.setUint32(16, 16, !0),
                    o.setUint16(20, 1, !0),
                    o.setUint16(22, n ? 1 : 2, !0),
                    o.setUint32(24, t, !0),
                    o.setUint32(28, 4 * t, !0),
                    o.setUint16(32, 4, !0),
                    o.setUint16(34, 16, !0),
                    i(o, 36, "data"),
                    o.setUint32(40, 2 * e.length, !0),
                    function(t, e, n) {
                        for (var r = 44, i = 0; i < n.length; i += 1,
                        r += 2) {
                    ...
                    for (var n = t.length + e.length, r = new Float32Array(n), i = 0, o = 0; i < n; )
                        r[i += 1] = t[o],
                        r[i += 1] = e[o],
                        o += 1;
                    return r
                ...
                postMessage(u)
                console.log("音声データがここに格納されています:", u);
                console.log("音声データがここに格納されています:", s);
                console.log("音声データがここに格納されています:", a);
            }
        ...
        var Pt = function() {
            function t() {
                ...
                this.showTimescale = !1,
                this.isScrolling = !1,
                this.fadeType = "logarithmic",
                this.masterGain = 1,
                this.annotations = [],
                this.durationFormat = "hh:mm:ss.uuu",
                this.isAutomaticScroll = !1,
                this.resetDrawTimer = void 0
            }
            var n, r;
            return h(t, [{
                key: "initExporter",
                value: function() {
                    this.exportWorker = new (w())(xt)
                }
            }, {
                key: "initRecorder",
                value: function(t) {
                    ...
                    this.mediaRecorder.ondataavailable = function(t) {
                        if (e.chunks.push(t.data),
                        !e.working) {
                            var n = new Blob(e.chunks,{
                                type: "audio/ogg; codecs=opus"
                            });
                            F.createLoader(n, e.ac).load().then((function(t) {
                                e.recorderWorker.postMessage({
                                    samples: t.getChannelData(0),
                                    samplesPerPixel: e.samplesPerPixel
                                }),
                                e.recordingTrack.setCues(0, t.duration),
                                e.recordingTrack.setBuffer(t),
                                e.recordingTrack.setPlayout(new vt(e.ac,t,e.masterGainNode)),
                                e.adjustDuration()
                            }
                            )).catch((function() {
                                e.working = !1
                    ...
                    ,
                    this.recorderWorker = new (w())(wt),
                    this.recorderWorker.onmessage = function(t) {
                        e.recordingTrack.setPeaks(t.data),
                        e.working = !1,
                        e.drawRequest()
                    }
                }
                ...
                value: function(t) {
                    this.ac = t,
                    this.masterGainNode = t.createGain()
                }
            }, {
                key: "getAudioContext",
                value: function() {
                ...
                value: function(t) {
                    ...
                    this.annotationList = new bt(this,t.annotations,t.controls,t.editable,t.linkEndpoints,t.isContinuousPlay,e)
                }
            }, {
                key: "setEffects",
                value: function(t) {
                ...
                value: function() {
                    ...
                    e.on("select", (function(e, n, r) {
                        t.isPlaying() ? (t.lastSeeked = e,
                        t.pausedAt = void 0,
                        t.restartPlayFrom(e)) : (t.seek(e, n, r),
                        t.ee.emit("timeupdate", e),
                        t.drawRequest())
                    }
                    )),
                    ...
                    e.on("shift", (function(e, n) {
                        n.setStartTime(n.getStartTime() + e),
                        t.adjustDuration(),
                        t.drawRequest()
                    }
                    )),
                    ...
                    e.on("fadein", (function(e, n) {
                        n.setFadeIn(e, t.fadeType),
                        t.drawRequest()
                    }
                    )),
                    e.on("fadeout", (function(e, n) {
                        n.setFadeOut(e, t.fadeType),
                        t.drawRequest()
                    }
                    )),
                    e.on("stereopan", (function(e, n) {
                        n.setStereoPanValue(e),
                        t.drawRequest()
                    }
                    )),
                    ...
                    e.on("trim", (function() {
                        ...
                        e.trim(n.start, n.end),
                        e.calculatePeaks(t.samplesPerPixel, t.sampleRate),
                        t.setTimeSelection(0, 0),
                        t.adjustDuration(),
                        t.drawRequest()
                    }
                    )),
                    e.on("zoomin", (function() {
                        var e = Math.max(0, t.zoomIndex - 1)
                          , n = t.zoomLevels[e];
                        n !== t.samplesPerPixel && (t.setZoom(n),
                        t.drawRequest())
                    }
                    )),
                ...
                value: function(t) {
                    var e = this
                      , n = t.map((function(t) {
                        return F.createLoader(t.src, e.ac, e.ee).load().then((function(t) {
                            return t.sampleRate === e.sampleRate ? t : function(t, e) {
                                var n = Math.ceil(t.duration * e)
                                  , r = new (window.OfflineAudioContext || window.webkitOfflineAudioContext)(t.numberOfChannels,n,e)
                    ...
                    return Promise.all(n).then((function(n) {
                        ...
                        var r = n.map((function(n, r) {
                            var i = t[r]
                              ...
                              , k = i.stereoPan || 0
                              , b = i.effects || null
                              , w = new vt(e.ac,n,e.masterGainNode)
                              , x = new pt;
                            return x.src = i.src,
                            x.setBuffer(n),
                            x.setName(o),
                            x.setEventEmitter(e.ee),
                            x.setEnabledStates(s),
                            x.setCues(l, h),
                            x.setCustomClass(m),
                            x.setWaveOutlineColor(g),
                            void 0 !== u && x.setFadeIn(u.duration, u.shape),
                            void 0 !== c && x.setFadeOut(c.duration, c.shape),
                            void 0 !== v && (e.setActiveTrack(x),
                            e.setTimeSelection(v.start, v.end)),
                            void 0 !== y && x.setPeakData(y),
                            x.setState(e.getState()),
                            x.setStartTime(a),
                            x.setPlayout(w),
                            x.setGainLevel(f),
                            x.setStereoPanValue(k),
                            b && x.setEffects(b),
                            p && e.muteTrack(x),
                            d && e.soloTrack(x),
                            x.calculatePeaks(e.samplesPerPixel, e.sampleRate),
                            x
                        }
                        ));
                        e.tracks = e.tracks.concat(r),
                        e.adjustDuration(),
                        e.draw(e.render()),
                        e.ee.emit("audiosourcesrendered")
                    }
                    )).catch((function(t) {
                ...
                value: (n = p().mark((function t(e) {
                    ...
                    return p().wrap((function(t) {
                        for (; ; )
                            ...
                            case 2:
                                return this.isRendering = !0,
                                this.offlineAudioContext = new (window.OfflineAudioContext || window.webkitOfflineAudioContext)(2,44100 * this.duration,44100),
                                n = [],
                                this.ee.emit("audiorenderingstarting", this.offlineAudioContext, n),
                                r = this.offlineAudioContext.currentTime,
                                i = this.offlineAudioContext.createGain(),
                                this.tracks.forEach((function(t) {
                                    var e = new vt(a.offlineAudioContext,t.buffer,i);
                                    e.setEffects(t.effectsGraph),
                                    e.setMasterEffects(a.effectsGraph),
                                    t.setOfflinePlayout(e),
                                    t.schedulePlay(r, 0, 0, {
                            ...
                            case 13:
                                o = t.sent,
                                "buffer" === e ? (this.ee.emit("audiorenderingfinished", e, o),
                                this.isRendering = !1) : "wav" === e && (this.exportWorker.postMessage({
                                    command: "init",
                                    config: {
                                        sampleRate: 44100
                                    }
                                ...
                                this.exportWorker.onmessage = function(t) {
                                    a.ee.emit("audiorenderingfinished", e, t.data),
                                    a.isRendering = !1,
                                    a.exportWorker.postMessage({
                                        command: "clear"
                                    })
                                }
                                ,
                ...
                value: function(t) {
                    var e = this;
                    this.samplesPerPixel = t,
                    this.zoomIndex = this.zoomLevels.indexOf(t),
                ...
                key: "removeTrack",
                value: function(t) {
                    t.isPlaying() && t.scheduleStop(),
                    [this.mutedTracks, this.soloedTracks, this.collapsedTracks, this.tracks].forEach((function(e) {
                        var n = e.indexOf(t);
                        n > -1 && e.splice(n, 1)
                    }
                    )),
                ...
                value: function(t) {
                    var e;
                    return this.soloedTracks.length > 0 ? (e = !1,
                    this.soloedTracks.indexOf(t) > -1 && (e = !0)) : (e = !0,
                    this.mutedTracks.indexOf(t) > -1 && (e = !1)),
                    e
                }
            }, {
                key: "isPlaying",
                ...
                value: function(t, e) {
                    ...
                    var r = this.ac.currentTime
                      ...
                      , s = e;
                    return !s && i.end !== i.start && i.end > a && (s = i.end),
                    this.isPlaying() ? this.restartPlayFrom(a, s) : (this.effectsGraph && this.tracks && this.tracks[0].playout.setMasterEffects(this.effectsGraph),
                    this.tracks.forEach((function(t) {
                        t.setState("cursor"),
                        o.push(t.schedulePlay(r, a, s, {
                    ...
                    this.lastPlay = r,
                    this.playoutPromises = o,
                    this.startAnimation(a),
                    Promise.all(this.playoutPromises))
                }
            }, {
                key: "pause",
                value: function() {
                    return this.isPlaying() ? (this.pausedAt = this.getCurrentTime(),
                    this.playbackReset()) : Promise.all(this.playoutPromises)
                }
            }, {
                key: "stop",
                value: function() {
                    return this.mediaRecorder && "recording" === this.mediaRecorder.state && this.mediaRecorder.stop(),
                ...
                value: function() {
                    var t = this;
                    return this.lastSeeked = void 0,
                    this.stopAnimation(),
                    this.tracks.forEach((function(e) {
                        e.scheduleStop(),
                        e.setState(t.getState())
                    }
                    )),
                ...
                value: function() {
                    var t = this;
                    return this.stop().then((function() {
                        t.viewDuration < t.duration ? t.scrollLeft = t.duration - t.viewDuration : t.scrollLeft = 0,
                        t.ee.emit("select", t.duration, t.duration)
                    }
                    ))
                }
            }, {
                ...
                value: function() {
                    ...
                    this.tracks.forEach((function(n) {
                        n.setState("none"),
                        e.push(n.schedulePlay(t.ac.currentTime, 0, void 0, {
                ...
                key: "seek",
                value: function(t, e, n) {
                    this.isPlaying() ? (this.lastSeeked = t,
                    this.pausedAt = void 0,
                    this.restartPlayFrom(t)) : (this.setActiveTrack(n || this.tracks[0]),
                    this.pausedAt = t,
                    this.setTimeSelection(t, e),
                    "fill" === this.getSeekStyle() && (this.playbackSeconds = t))
                }
            }, {
                key: "updateEditor",
                value: function(t) {
                    ...
                    if (this.isPlaying()) {
                        var a = i + o;
                        this.ee.emit("timeupdate", a),
                        this.animationRequest = window.requestAnimationFrame((function() {
                            e.updateEditor(a)
                        }
                        )),
                        this.playbackSeconds = a,
                        this.draw(this.render()),
                        this.lastDraw = n
                    } else
                        i + o >= (this.isSegmentSelection() ? r.end : this.duration) && this.ee.emit("finished"),
                        this.stopAnimation(),
                ...
                value: function(t) {
                    var e = m()(this.tree, t);
                    this.rootNode = k()(this.rootNode, e),
                    this.tree = t,
                    this.viewDuration = P(this.rootNode.clientWidth - this.controls.width, this.samplesPerPixel, this.sampleRate)
                }
            }, {
                ...
                value: function() {
                    ...
                    return new N(this.duration,this.scrollLeft,this.samplesPerPixel,this.sampleRate,t,this.colors).render()
                }
            }, {
                ...
                value: function() {
                    ...
                    return v()("div.playlist-tracks", {
                        ...
                        onscroll: function(e) {
                            t.scrollLeft = P(e.target.scrollLeft, t.samplesPerPixel, t.sampleRate),
                            t.ee.emit("scroll")
                        },
                        hook: new I(this)
                    }, e)
                ...
                value: function() {
                    var t = [];
                    return this.showTimescale && t.push(this.renderTimeScale()),
                    t.push(this.renderTrackSection()),
                    this.annotationList.length && t.push(this.renderAnnotations()),
                    v()("div.playlist", {
                        attributes: {
        ...
        function St() {
            ...
            var r = e()({}, t, {
              ...
              , i = r.zoomLevels.indexOf(r.samplesPerPixel);
            if (-1 === i)
                throw new Error("initial samplesPerPixel must be included in array zoomLevels");
            var a = new Pt
              , u = r.ac || new AudioContext;
            a.setAudioContext(u),
            a.setSampleRate(r.sampleRate || u.sampleRate),
            a.setSamplesPerPixel(r.samplesPerPixel),
            a.setEventEmitter(n),
            a.setUpEventEmitter(),
            a.setTimeSelection(0, 0),
            a.setState(r.state),
            a.setControlOptions(r.controls),
            a.setWaveHeight(r.waveHeight),
            a.setCollapsedWaveHeight(r.collapsedWaveHeight),
            a.setColors(r.colors),
            a.setZoomLevels(r.zoomLevels),
            a.setZoomIndex(i),
            a.setMono(r.mono),
            a.setExclSolo(r.exclSolo),
            a.setShowTimeScale(r.timescale),
            a.setSeekStyle(r.seekStyle),
            a.setAnnotations(r.annotationList),
            a.setBarGap(r.barGap),
            a.setBarWidth(r.barWidth),
            a.isAutomaticScroll = r.isAutomaticScroll,
            a.isContinuousPlay = r.isContinuousPlay,
            a.linkedEndpoints = r.linkedEndpoints,
            r.effects && a.setEffects(r.effects);
            var c = a.render()
              , l = o()(c);
            return r.container.appendChild(l),
            a.tree = c,
            a.rootNode = l,
            a
        }
        function Tt() {
            return St(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s()())
        }
    }
    )(),
    WaveformPlaylist = r
