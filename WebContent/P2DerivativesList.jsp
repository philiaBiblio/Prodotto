	...
	<section class="video-grid">
		<div class="video-card">
			<div class="thumbnail-placeholder">
				<img src="image/" alt="Video Thumbnail" class="thumbnail" />
				<%
				if (TList != null) {
				%>
				<%
				...
				<!-- 音声再生ボタン -->
				<audio class="audio-player" src=<%=TList.get(i).getSound()%>></audio>
			</div>

			<div class="video-info">
				<a href="P2ProfileMine.jsp" class="profile-info"> <img
					src="image/" alt="profile icon" class="profile-icon" />
				</a>
				<div class="like-comment">
					<button class="comment" onclick="openPopup()">
						<img src="image/" alt="comment icon"
							style="width: 20px; height: 20px" /> <span>5</span>
					</button>

					<button class="heart" onclick="changeImage('heartImage2')">
						<img id="heartImage2" src="image/Heart-512x512 test.png"
							alt="like icon" style="width: 20px; height: 20px" /> <span>10</span>
					</button>

					<button>
						<span> <a href="P2Recording.jsp">
								<div class="nav_icon">
		...
		<div class="song-bar">
			<div class="song-infos">
				...
				<div class="song-description">
					<p class="title">Watashitachi wa Sou Yatte Ikite Iku Jinshu na
						no</p>
		...
		<div class="progress-controller">
			<div class="control-buttons">
				<i class="fas fa-random"></i> <i class="fas fa-step-backward"></i> <i
					class="play-pause fas fa-play"></i> <i class="fas fa-step-forward"></i>
