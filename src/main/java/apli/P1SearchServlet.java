				...
				if (title == null || title.trim().isEmpty()) {
					...
					if(toukouList != null) {
						for(int i = 0; i < toukouList.size(); i++) {
							if(i >= 1) {
								System.out.println("138：" + toukouList.get(i).getToukouid());
				    			listword = listword + ",'" + toukouList.get(i).getToukouid() + "'";
				    			System.out.println("140：" + listword);
				    			}else {
				    				System.out.println("142：" + toukouList.get(i).getToukouid());
					    			listword = listword + "'" + toukouList.get(i).getToukouid() + "'";
					    			System.out.println("144：" + listword);
				    		  }	
						}
					}
